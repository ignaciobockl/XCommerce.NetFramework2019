...
-- --------------------------------------------------
-- Date Created: 12/19/2019 14:49:32
-- Generated from EDMX file: E:\Mega\Tecnicatura Superior en Programacion\2 Cuatrimestre\Laboratorio de Computacion II\FINAL BACKUP\XCommerce\XCommerce.AccesoDatos\ModeloXCommerce.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_ReservaMotivoReserva]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Reservas] DROP CONSTRAINT [FK_ReservaMotivoReserva];
GO
...
GO
IF OBJECT_ID(N'[dbo].[MotivoReservaSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MotivoReservaSet];
GO
...
CREATE TABLE [dbo].[Direcciones] (
    ...
    [Casa] nvarchar(5)  NULL,
    [Lote] nvarchar(5)  NULL,
    [Mza] nvarchar(5)  NULL,
...
CREATE TABLE [dbo].[Usuarios] (
    [Id] bigint IDENTITY(1,1) NOT NULL,
    [NombreUser] nvarchar(100)  NOT NULL,
...
CREATE TABLE [dbo].[Reservas] (
    ...
    [MotivoReservaId] bigint  NULL,
    [MotivoReserva_Id] bigint  NULL
);
GO
...
-- Creating table 'MotivoReservaSet'
CREATE TABLE [dbo].[MotivoReservaSet] (
    [Id] bigint  NOT NULL,
...
CREATE TABLE [dbo].[Personas_Cliente] (
    ...
    [MontoDeudaCtaCte] decimal(18,0)  NOT NULL,
...
-- Creating primary key on [Id] in table 'MotivoReservaSet'
ALTER TABLE [dbo].[MotivoReservaSet]
ADD CONSTRAINT [PK_MotivoReservaSet]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating foreign key on [MotivoReserva_Id] in table 'Reservas'
ALTER TABLE [dbo].[Reservas]
ADD CONSTRAINT [FK_ReservaMotivoReserva]
    FOREIGN KEY ([MotivoReserva_Id])
    REFERENCES [dbo].[MotivoReservaSet]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_ReservaMotivoReserva'
CREATE INDEX [IX_FK_ReservaMotivoReserva]
ON [dbo].[Reservas]
    ([MotivoReserva_Id]);
GO
